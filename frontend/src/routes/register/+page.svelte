...
<div class="max-w-md mx-auto mt-10 bg-gray-800 p-6 rounded-lg shadow-lg">
  ...
  <form on:submit|preventDefault={handleRegister} class="space-y-4">
    <div>
      ...
      <input type="text" bind:value={username} class="w-full bg-gray-700 text-white rounded p-2 focus:outline-none focus:ring-2 focus:ring-purple-500" required />
    </div>
    
    <div>
      <label class="block text-gray-400 mb-1">Email</label>
      <input type="email" bind:value={email} class="w-full bg-gray-700 text-white rounded p-2 focus:outline-none focus:ring-2 focus:ring-purple-500" required />
    </div>
    
    <div>
      <label class="block text-gray-400 mb-1">Password</label>
      <input type="password" bind:value={password} class="w-full bg-gray-700 text-white rounded p-2 focus:outline-none focus:ring-2 focus:ring-purple-500" required />
    </div>
